...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="${pageContext.request.contextPath}/admin/category">Product</a></li>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                        ...
                        <tbody>
                        <product:forEach var="product" items="${products}">
                            <tr role="row" class="odd">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/product/edit/${product.id}">Edit</a>
                                    ...
                                    <a href="${pageContext.request.contextPath}/admin/product/photo/${product.id}">Photos</a>
                                    |
                                    <a href="${pageContext.request.contextPath}/admin/product/addphoto/${product.id}">Add photo</a>
