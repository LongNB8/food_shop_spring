...
<%@taglib prefix="product" uri="http://java.sun.com/jsp/jstl/core" %>

<section class="content-header">
    <h1>
        Photo List of ${product.name}
                ...
                <div class="box-body">
                    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Main</th>
                        ...
                        <tbody>
                        <product:forEach var="photo" items="${product.photos}">
                            <tr role="row" class="odd">
                                ...
                                <td>${photo.main ? 'main' : 'nomain'}</td>

                                <td>
                                <a href="${pageContext.request.contextPath}/admin/product/editPhoto/${photo.id}">Edit</a>
                                    |
                                    <a href="${pageContext.request.contextPath}/admin/photo/delete/${product.id}"
