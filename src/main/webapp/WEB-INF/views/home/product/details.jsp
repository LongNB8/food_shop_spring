            ...
            <div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <a href="${pageContext.request.contextPath}/uploads/images/${p.name}"> <img style="width:29%" src="${pageContext.request.contextPath}/uploads/images/${p.name}" alt=""></a>
                ...
                <div class="tab-pane fade" id="profile">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="blockView">
                            <ul class="thumbnails">
                                <c:forEach var="relatedPro" items="${relatedProduct}">
                                    <c:set var="photo" value="${relatedPro.getPhotos().stream().filter(p -> p.isStatus() && p.isMain()).findFirst().get()}"></c:set>
                                <li class="span3">
                                    <div class="thumbnail">
                                        <a href="${pageContext.request.contextPath}/product/details/${relatedPro.id}"><img src="${pageContext.request.contextPath}/uploads/images/${photo.name}" alt=""></a>
                                        <div class="caption">
                                            <h5>${relatedPro.name}</h5>
                                            <p>
                                                ${relatedPro.description}
                                            </p>
                                            <h4 style="text-align:center"><a class="btn" href="${pageContext.request.contextPath}/product/details/${relatedPro.id}"> <i class="icon-zoom-in"></i></a> <a class="btn" href="${pageContext.request.contextPath}/cart/buy/${product.id}">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">
                                                    $${relatedPro.price}</a></h4>
                                        </div>
                                    </div>
                                </li>
                                </c:forEach>
